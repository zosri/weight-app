 ...
 * Ρόλος ζυγίσματος.
 *
 * Μόνο το πρώτο ζύγισμα της ημέρας τρέφει την τάση. Το βραδινό είναι
 * συστηματικά 0.5-1 κιλό πάνω από το πρωινό (φαγητό και νερό μέσα στη
 * μέρα), οπότε αν μπει στην ίδια σειρά EWMA μετατοπίζει την τάση ανάλογα
 * με το *πότε έτυχε* να ζυγιστείς — θόρυβος συγκρίσιμος με το σήμα όταν
 * περιμένεις μισό κιλό την εβδομάδα.
 *
